...
|------|----------------|----------------------|:------:|
| **Pin library versions** | Reproducible builds – no “works-on-my-machine.” | Freeze every runtime dep in `requirements.txt` with exact versions. Add install step to CI. | [X] |
